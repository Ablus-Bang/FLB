...
class LoraConfig(_message.Message):
    ...
    def __init__(
        self,
        config_name: _Optional[str] = ...,
        config_value: _Optional[_Union[_struct_pb2.Value, _Mapping]] = ...,
    ) -> None: ...
...
class ClientGrpcMessage(_message.Message):
    ...
    class SendParameters(_message.Message):
        ...
        def __init__(
            ...
            train_dataset_length: _Optional[int] = ...,
            new_model_weight: _Optional[_Mapping[str, bytes]] = ...,
            lora_config: _Optional[_Iterable[_Union[LoraConfig, _Mapping]]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        send_parameters: _Optional[
            _Union[ClientGrpcMessage.SendParameters, _Mapping]
        ] = ...,
        get_new_version: _Optional[
            _Union[ClientGrpcMessage.GetNewVersion, _Mapping]
        ] = ...,
    ) -> None: ...
