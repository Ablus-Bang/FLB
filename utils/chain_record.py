...
def send_weight(weight_dict):
    ...
    token_send_signed_txn = web3.eth.account.sign_transaction(dict(
    ...
    token_send_txn_hash = web3.eth.send_raw_transaction(token_send_signed_txn.rawTransaction)
    ...
    transaction = weight_contract.functions.uploadUserData(weight_dict).build_transaction({
